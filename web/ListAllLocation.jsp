<%-- 
    Document   : ListAllLocation
    Created on : Nov 2, 2019, 9:02:53 PM
    Author     : LENOVO
--%>
        ...
        <div class="container">
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><%=count++%></td>
                        <td><%=p.getPlace_name()%></td>   
                        <td>    
                <center>

                    <form action="DeleteLocation" method="post" onsubmit="return confirm('You really want to delete?');">       
                        <button type="submit"><span class="glyphicon glyphicon-trash"  ></span></button>
                        <input type="hidden" name="place_id" value="<%=p.getPlace_id()%>"> 
                    </form>  
                </center>
                </td>
                </tr>
